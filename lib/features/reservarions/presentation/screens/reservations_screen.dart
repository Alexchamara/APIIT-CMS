...
import 'package:apiit_cms/features/reservarions/presentation/screens/add_reservation_screen.dart';
import 'package:apiit_cms/features/reservarions/presentation/widgets/reservation_card.dart';
...
class _ReservationsScreenState extends State<ReservationsScreen> {
  ...
  Future<void> _cancelReservation(ReservationModel reservation) async {
    try {
      await ReservationRepository.cancelReservation(reservation.id);
      _loadReservations();
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
